...
@section('content')
    <div class="block ">
        ...
        <div class="field-wrap ">
            ...
            <input type="text" data-field-type="string" data-field-name="copyright" data-block="static_all_site"
                   class="input block_field" value="{{$static_all_site->copyright_field}}" placeholder="Строка">
        </div>
        <div class="field-wrap ">
            <label class="input-file">
                Адресс
            </label>
            <input type="text" data-field-type="string" data-field-name="adress" data-block="static_all_site"
                   class="input block_field" value="{{$static_all_site->adress_field}}" placeholder="Строка">
        </div>
        <div class="field-wrap ">
            <label class="input-file">
                Почта
            </label>
            <input type="text" data-field-type="string" data-field-name="mail" data-block="static_all_site"
                   class="input block_field" value="{{$static_all_site->mail_field}}" placeholder="Строка">
        </div>
